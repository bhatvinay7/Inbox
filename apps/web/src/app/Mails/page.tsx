...
export default function Mails() {
  ...
  return (
    <div  className=' flex flex-col w-full relative items-center  bg-white h-screen '>
      <div className=" w-full sticky top-19 z-35 ">
      <Pagination/>
      </div>
      {value && <UserProfileWindow/> }
        <div className="overflow-y-auto w-full scrollbar-thin scrollbar-thumb-gray-400 overflow-x-hidden scrollbar-track-gray-200 space-y-1">
          {[...Array(10)].map((_, i) => (
            <Card key={i} className=" hover:bg-gray-100 border border-black/10 hover:scale-[101%] px-1  overflow-x-hidden rounded-none  cursor-pointer">
              <CardContent className="flex items-center overflow-x-hidden justify-between p-2">
                ...
                <div className="flex-1 ml-4 text-gray-700 text-base truncate font-medium font-sans">Email subject line example - message preview text goes here...</div>
